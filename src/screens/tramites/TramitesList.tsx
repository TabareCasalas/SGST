...
const TramitesList: React.FC = () => {
  ...
  const { tramites, isLoading, error } = useTramites();
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-500">
              {isLoading ? 'Cargando...' : `${filteredTramites.length} trámites encontrados`}
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
                  ...
                  <tr>
                    <td colSpan={7} className="px-6 py-12 text-center">
                      <div className="flex justify-center items-center">
                        ...
                        <span className="ml-2 text-gray-600">Cargando trámites...</span>
                      </div>
                    </td>
                  </tr>
                ) : (
          ...
          {!isLoading && filteredTramites.length === 0 && (
